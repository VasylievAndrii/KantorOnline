...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  try {
    // Проверка наличия криптовалюты в кошельке пользователя
    ...
    if (!$wallet || $wallet['amount'] < $amount) {
        throw new Exception("Niewystarczająca ilość kryptowaluty do sprzedaży");
    }
    ...
    echo json_encode([
        "status" => "success",
        "message" => "Kryptowaluta została pomyślnie sprzedana",
